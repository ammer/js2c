...
function CCodegen(ast, entryFuncName, funcDefs) {
    this.ast = ast;
    this.entryFuncName = entryFuncName;
    this.funcDefs = funcDefs; // function prototype from included json file
...
module.exports = function() {
    return function(ast, entryName, funcDefs) { return new CCodegen(ast, entryName, funcDefs); };
};
